    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 10; i < 200; i += 10)
            {
                ...
                TesterArray testerArray = new TesterArray(i, stepCount, searchValues, fillValues);
                ...
                TesterDictionary testerDictionary = new TesterDictionary(i, stepCount, searchValues, fillValues);
                GCSettings.LargeObjectHeapCompactionMode = GCLargeObjectHeapCompactionMode.CompactOnce;
                GC.Collect(2, GCCollectionMode.Forced, true, true);
                for (int j = 0; j < 10; ++j)
                ...
                TesterSortedList testerSortedList = new TesterSortedList(i, stepCount, searchValues, fillValues);
                GCSettings.LargeObjectHeapCompactionMode = GCLargeObjectHeapCompactionMode.CompactOnce;
                GC.Collect(2, GCCollectionMode.Forced, true, true);
                for (int j = 0; j < 10; ++j)
            ...
            foreach (var item in array1)
                Console.WriteLine((item * 100) / (m_ArrayLength * stepCount));
